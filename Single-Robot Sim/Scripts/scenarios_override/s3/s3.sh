#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/sim/scenarios_override/s3/d3.sh"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 2.32,max_translation_speed: 0.46}"
